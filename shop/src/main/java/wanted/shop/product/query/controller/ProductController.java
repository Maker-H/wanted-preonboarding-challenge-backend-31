...
public class ProductController {
    ...
    public SuccessResponse<ProductDto> findProduct(@PathVariable Long productId) {
        ProductDto response = getProductDetailQueryHandler.handle(new ProductId(productId));
